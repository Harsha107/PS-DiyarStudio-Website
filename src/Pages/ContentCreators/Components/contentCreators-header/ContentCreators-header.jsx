  ...
  return (
    <div className='navbar-container'>
      <div className="top-nav">
        <span className="nav-photography"><a href="/photography" className="tn-link1"><h4>Photography</h4></a></span>
        ...
        <span className="nav-contentCreators">
            <a href="/content-creators" className="tn-link4">
                <h4 style={{textDecoration: 'underline', textDecorationColor: '#fff', textUnderlineOffset: '0.4em'}}>Content Creators</h4>
            </a>
        </span>
      </div>
