    ...
    <div className='navbar-container'>
      <div className="top-nav">
        <span className="nav-photography">
            <a href="/photography" className="tn-link1"><h4>Photography</h4></a>
        </span>
      ...
      <div className="below-nav">
        ...
        <div className="nav-content-container">
          <ul className="nav-uList">
            <li className="bn-about">
                <a href="/about-us" className='bn-list-item' style={{textDecoration: 'none'}}>About</a>
            </li>
            ...
            <li className="bn-contact"><a href="/contact-us/lets+work+together" className='bn-list-item' style={{textDecoration: 'underline', textUnderlineOffset: '0.4em'}}>Contact</a></li>
          </ul>
          {Mobile &&
