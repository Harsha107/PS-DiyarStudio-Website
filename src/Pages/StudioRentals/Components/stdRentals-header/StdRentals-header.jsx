  ...
  return (
    <div className='navbar-container'>
      <div className="top-nav">
        ...
        <span className="nav-studioRentals">
            <a href="/studio-rentals" className="tn-link3">
                <h4 style={{textDecoration: 'underline', textDecorationColor: '#fff', textUnderlineOffset: '0.4em'}}>Studio Rentals</h4>
            </a>
        </span>
