  ...
  return (
    <div className='navbar-container'>
      <div className="top-nav">
        ...
        <span className="nav-videography">
            <a href="/videography" className="tn-link2">
                <h4 style={{textDecoration: 'underline', textDecorationColor: '#fff', textUnderlineOffset: '0.4em'}}>Videography</h4>
            </a>
        </span>
